const zh = {
  ...
  sleepConfirm: '睡觉',
  upgradeInfo: '升级说明',
  upgradeInfoDesc: '土地品质升级路线',
  cost: '费用',
  reqLevel: '需要等级',
  landQuality: '土地品质',
  effect: '效果',
  normalLand: '普通土地',
  normalLandDesc: '基础农田，32块',
  premiumLand: '高级土地',
  premiumLandDesc: '产量+50%，32块',
  epicLand: '史诗土地',
  epicLandDesc: '产量+100%，32块',
  spiritRain: '灵雨术',
  spiritRainSuccess: '灵雨术施展成功',
  grandSpiritRain: '大型灵雨术',
  grandSpiritRainSuccess: '大型灵雨术施展成功，覆盖{n}块',
  mana: '法力',
  technique: '功法',
  techniqueUpgrade: '升级功法',
  qingxinJue: '清心决',
  manaBonus: '法力加成',
  expRequired: '需要经验',
  techniqueLevel: '功法等级',
...
const en = {
  ...
  hour: 'hr',
  sleepConfirm: 'Sleep',
  upgradeInfo: 'Upgrade Guide',
  upgradeInfoDesc: 'Land quality upgrade route',
  cost: 'Cost',
  reqLevel: 'Req Lv',
  landQuality: 'Land Quality',
  effect: 'Effect',
  normalLand: 'Normal Land',
  normalLandDesc: 'Basic farmland, 32 plots',
  premiumLand: 'Premium Land',
  premiumLandDesc: 'Yield +50%, 32 plots',
  epicLand: 'Epic Land',
  epicLandDesc: 'Yield +100%, 32 plots',
  spiritRain: 'Spirit Rain',
  spiritRainSuccess: 'Spirit Rain cast successfully',
  grandSpiritRain: 'Grand Spirit Rain',
  grandSpiritRainSuccess: 'Grand Spirit Rain cast on {n} plots',
  mana: 'Mana',
  technique: 'Technique',
  techniqueUpgrade: 'Upgrade Technique',
  qingxinJue: 'Qingxin Jue',
